...
export const ScrollStackItem: React.FC<ScrollStackItemProps> = ({
  ...
  <div
    className={`scroll-stack-card relative w-full h-[70vh] my-8 p-8 rounded-[40px] bg-[#0A0118]/90 border border-[#A020F0]/30 shadow-[0_0_30px_rgba(160,32,240,0.2)] box-border origin-top will-change-transform backdrop-blur-sm ${itemClassName}`.trim()}
    style={{
